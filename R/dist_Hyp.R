###############################################################
###                                                         ###
###   Multivariate Hyperbolic Mixture for Incomplete Data   ###
###                                                         ###
###############################################################

MHM_incomplete_data <- function(
    X,
    G,
    max_iter     = 20,
    epsilon      = 0.01,
...
###############################################################
###                                                         ###
###    Multivariate Hyperbolic Mixture for Complete Data    ###
###                                                         ###
###############################################################

MHM_complete_data <- function(
    X,
    G,
    max_iter     = 20,
    epsilon      = 0.01,
