##################################################################################
###                                                                            ###
###  Multivariate Hyperbolic Univariate Marginals Mixture for Incomplete Data  ###
###                                                                            ###
##################################################################################

MHUMM_incomplete_data <- function(
    X,
    G,
    max_iter     = 20,
    epsilon      = 0.01,
...
################################################################################
###                                                                          ###
###  Multivariate Hyperbolic Univariate Marginals Mixture for Complete Data  ###
###                                                                          ###
################################################################################

MHUMM_complete_data <- function(
    X,
    G,
    max_iter     = 20,
    epsilon      = 0.01,
