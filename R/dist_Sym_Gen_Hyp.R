###################################################################################
###                                                                             ###
###  Multivariate Symmetric Generalized Hyperbolic Mixture for Incomplete Data  ###
###                                                                             ###
###################################################################################

MSGHM_incomplete_data <- function(
    X,
    G,
    max_iter     = 20,
    epsilon      = 0.01,
...
#################################################################################
###                                                                           ###
###  Multivariate Symmetric Generalized Hyperbolic Mixture for Complete Data  ###
###                                                                           ###
#################################################################################

MSGHM_complete_data <- function(
    X,
    G,
    max_iter     = 20,
    epsilon      = 0.01,
