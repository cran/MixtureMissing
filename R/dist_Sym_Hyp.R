###########################################################################
###                                                                     ###
###    Multivariate Symmetric Hyperbolic Mixture for Incomplete Data    ###
###                                                                     ###
###########################################################################

MSHM_incomplete_data <- function(
    X,
    G,
    max_iter     = 20,
    epsilon      = 0.01,
...
###########################################################################
###                                                                     ###
###     Multivariate Symmetric Hyperbolic Mixture for Complete Data     ###
###                                                                     ###
###########################################################################

MSHM_complete_data <- function(
    X,
    G,
    max_iter     = 20,
    epsilon      = 0.01,
